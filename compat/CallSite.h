...
// Reduce the chunck byte into IR and Refractor the code as much as possible
// Establish the code the view for Disassmebler
// One byte is dereferenceable and the pointer is in addrspace(0)
// Convert the byte into chunks for entry address point %% exit_address can't be determine